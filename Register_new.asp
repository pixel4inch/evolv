...
<div class="body-content">
  <div class="w-100 mt-3">
    <form action="Register_new.asp" method="POST" id="formblock">
      <div class="row mx-0">
        <!-- Name -->
...
<script>
 ...
 <script type="text/javascript">
  ...
  var row = table.insertRow(-1).innerHTML = '<tr class="mt-2"><td class="col-sm-6  px-1"><input class="form-control w-100 border-radius-0 " placeholder="Name" id="company_board_first_name" name="company_board_first_name" type="text" required=""></td><td class="col-sm-6  px-1" ><input placeholder="Company" class="form-control w-100 border-radius-0 " id="company_board_first_name" name="company_board_first_name" type="text" required=""></td ></tr>';
  }
...
<script type="text/javascript">
  ...
  var row = table.insertRow(-1).innerHTML = '<tr class="mt-2"><td class="col-sm-8 col-12  px-1"><input class="form-control w-100 border-radius-0 " placeholder="Firm" id="company_board_first_name" name="company_board_first_name" type="text" required=""></td><td class="col-sm-4 col-12  px-1" ><input placeholder="Amount" class="form-control w-100 border-radius-0 " id="company_board_first_name" name="company_board_first_name" type="text" required=""></td ></tr>';
  }
