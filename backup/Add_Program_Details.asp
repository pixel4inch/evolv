              ...
              <div class="row mx-0" id="formblock">
                ...
                <div class="col-sm-6 mb-3 px-1">
                 ...
                 <div class="col-sm-12 mb-3 px-1">
                  <span class="formmandatory">* </span>
                  <input class="form-control w-100 border-radius-0" type="text" placeholder="Company URL" required="" id="companyURL" name="companyURL">
                </div>
                <!-- email -->
                <div class="col-sm-6 mb-3 px-1">
                  <span class="formmandatory">* </span>
                ...
                <!-- phone -->
                <div class="col-sm-6 mb-3 px-1">
                  <input class="form-control w-100 border-radius-0" type="number" placeholder="Phone" id="phone" name="phone">
                </div>
